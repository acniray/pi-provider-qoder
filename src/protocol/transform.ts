...
interface QoderMessage {
  ...
  /**
   * Qoder/qodercli replays model reasoning out-of-band. Putting it inside
   * content as <thinking>...</thinking> teaches reasoning models a textual
   * pseudo-protocol and can make later tool calls degrade into DSML/XML text.
   */
